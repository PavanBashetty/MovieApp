<template>
    <v-card-title class="text-xs-h6 text-md-h5 text-lg-h4">LoginPage</v-card-title><br />
    <v-responsive class="mx-auto"  max-width="344"><v-text-field type="email" placeholder="Enter your email" v-model="email" />
    <v-text-field type="password" placeholder="Enter your password" v-model="password" /></v-responsive>
